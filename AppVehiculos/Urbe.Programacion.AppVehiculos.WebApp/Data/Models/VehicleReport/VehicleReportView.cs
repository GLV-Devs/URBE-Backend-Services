...
public class VehicleReportView
{
    ...
    public VehicleReportView(Snowflake id, Guid ownerId, string vehicleModel, string licensePlate, string vehicleCountryAlpha3Code, VehicleMaintenanceType maintenanceType, uint? vehicleColor, DateTimeOffset lastEdited, DateTimeOffset created)
    {
        Id = id;
        OwnerId = ownerId;
